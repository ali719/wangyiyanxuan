<template>
  ...
  <div class="zhen">
    ...
    <div class="yang">
      ...
      <div class="recText">
        <div class="recTitle">
          <span>{{zhen.Item[0].title}}</span>
          <span>{{zhen.Item[0].priceInfo}}元起</span>
        </div>
        <div class="recInfo">{{zhen.Item[0].subTitle}}</div>
      </div>
    </div>
    <!--丁三石的好货推荐-->
    <div class="dinglei">
      ...
      <div class="image">
        ...
        <span class="imgText">{{zhen.Item[1].typeName}}</span>
      </div>
    </div>
    <!--挑款师推荐-->
    <div class="dinglei">
      ...
      <div class="image">
        ...
        <span class="imgText">{{zhen.Item[2].typeName}}</span>
      </div>
    </div>
  </div>
</template>
